...
{
    public class TheGreatAI_Test
    {
        GameWorld world;
        //Xunit way of using test initialize 
        public TheGreatAI_Test()
        {
        ...
        public void SmarterAI_EdgeMovmentYaxis_DirectionUp()
        {
            ...
            TheGreatAI AI = new TheGreatAI(world, new Position { x=5, y = 0 });
        ...
        public void SmarterAI_AiStartFoodEnd_DirectionLeft()
        {
            ...
            TheGreatAI AI = new TheGreatAI(world, new Position { x=3, y = 3 });
            world.gameObjects.Add(AI);
        ...
        public void CalculateXShortestPath_DirectionLeft()
        {
            ...
            TheGreatAI AI = new TheGreatAI(world, new Position { x=0, y = 6 });
            world.gameObjects.Add(AI);
        ...
        public void CalculateXShortestPath_DirectionRight()
        {
            ...
            TheGreatAI AI = new TheGreatAI(world, new Position { x=world.Width-15, y = 5 });
            world.gameObjects.Add(AI);
        ...
        public void CalculateYShortestPath_DirectionDown()
        {
            ...
            TheGreatAI AI = new TheGreatAI(world, new Position { x=5, y = world.Height-1 });
            world.gameObjects.Add(AI);
